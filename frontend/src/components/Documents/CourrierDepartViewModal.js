...
const CourrierDepartViewModal = ({ document, isOpen, onClose }) => {
          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 p-6 rounded-t-2xl flex-shrink-0">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Détails du Courrier Départ</h2>
                  <p className="text-blue-100 text-sm">Référence: {document.reference}</p>
                </div>
              </div>
              <button
                onClick={onClose}
              ...
              <div className="space-y-4 overflow-y-auto">
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <label className="text-sm font-semibold text-blue-700">Informations de création</label>
                  </div>
...
export default CourrierDepartViewModal;